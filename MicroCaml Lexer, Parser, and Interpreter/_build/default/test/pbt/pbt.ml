...
let test_simple_let = 
  ...
  (fun (w, x, y, z) ->
    ...
    ast = ([], Let ("validstring1", false, (Int w),
      Let ("validstring2", false,
      If ((Bool x), (Int y), (Int z)), ID "validstring2")))
  )
...
let test_operator_precedence = 
  ...
  (fun (x, y, z) ->
    ...
    ast = ([], Binop (lower_tok, Binop(higher_tok, (Int x), (Int y)), (Int z)))
  )
