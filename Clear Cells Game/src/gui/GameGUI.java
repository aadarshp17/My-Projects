...
/**
 * Represents the user interface for the game. You should
 * not modify this class in any way. 
 * 
	...
	public static void main(String[] args) {
		Runnable createShowGUI = new Runnable() {
			public void run() {
				...
				int strategy = Integer.parseInt(JOptionPane.showInputDialog(null, "Enter strategy (default 1)", 1));
				int timerDelayInMilliSecs = Integer.parseInt(JOptionPane.showInputDialog(null, "Enter speed in milliseconds", 2000));
				GameGUI.createAndDisplayGUI(new ProcessCellGame(maxRows, maxCols, new Random(), strategy), 
